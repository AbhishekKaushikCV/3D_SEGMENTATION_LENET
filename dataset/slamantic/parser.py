...
class SemanticSlamantic(Dataset):
    ...
    def __getitem__(self, dataset_index):
        ...
        for index in range(start_index, start_index + 1):
            ...
            scan.open_scan(scan_file, if_transform=self.transform_mod)
...
class Parser():
    ...
    def __init__(self,
        ...
        # Data loading code
        if self.split == 'train':
            self.train_dataset = SemanticSlamantic(root=self.root,
            ...
            self.valid_dataset = SemanticSlamantic(root=self.root,
